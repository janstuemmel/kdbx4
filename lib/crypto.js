 ...
 * @param {import("./header.js").KdfParams} params
 */
export const computeDerivedKey = (compositeKey, params) => {
  switch (params.type) {
    case 'AES-KDF':
      return computeAesKdf(compositeKey, params.S, params.R);
    default:
...
export const computeEncryptionKey = (compositeKey, params) => {};
